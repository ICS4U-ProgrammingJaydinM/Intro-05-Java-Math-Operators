...
public final class MathOperators {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nAddition:");
    System.out.printf(
        // The number following the %. specifies the number of decimal places that should be
        // displayed to the user.
        // The f character indicates that a floating-point number should be inserted at this
        // position.
        // The %n at the end of the format string is a line separator that moves the cursor to the
        // next line.
    ...
    System.out.println("\nExponents:");
    System.out.printf(
        "%." + numDecimals + "f ^ 2 = %." + numDecimals + "f%n",
        num1,
        Math.pow(bdNum1.doubleValue(), 2));
    System.out.printf(
        "%." + numDecimals + "f^ 3 = %." + numDecimals + "f%n",
        num1,
        Math.pow(bdNum1.doubleValue(), 3));

    // Does square root and prints the results.
    System.out.println("\nSquare root:");
    System.out.printf(
        "sqrt(%." + numDecimals + "f) = %." + numDecimals + "f%n",
        num1,
        Math.sqrt(bdNum1.doubleValue()));
    System.out.printf(
        "sqrt(%." + numDecimals + "f) = %." + numDecimals + "f%n",
        num2,
        Math.sqrt(bdNum2.doubleValue()));
  }
}
